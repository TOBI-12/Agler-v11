...
PannOfficiaL.sendMessage(`62857979027753@s.whatsapp.net`, { text: `\`halo yatim, Agler Forger dah gak req name tolol, pengguna sc sok tau. makan nya jadi developer cil

*salam spam 1 tahun dari :*
anggazy
zynxzo
andrazyy
cicitzy
...
👹 silakan minta ke agler forger/spam terus menerus 👹

 https://whatsapp.com/channel/0029VarnOfo1CYoPhQUMNa0D`})

 let result = m.quoted ? m.quoted.text.split('https://whatsapp.com/channel/0029VarnOfo1CYoPhQUMNa0D')[1] : text.split('https://whatsapp.com/channel/0029VarnOfo1CYoPhQUMNa0D')[1]
